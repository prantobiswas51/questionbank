<x-guest-layout>
    <div class="max-w-6xl mx-auto p-4">
        ...
        <div class="search_box py-2 mb-4 ">
            <form action="{{ route('part_a') }}" method="get" class="flex flex-wrap gap-2 items-center">
                <input type="text" name="search" class="rounded-lg border sm:min-w-[300px] border-gray-300"
                    placeholder="Search Part A Questions" value="{{ request('search') }}">
                ...
                <a href="{{ route('part_a') }}" class="border p-2 rounded-lg bg-red-500 text-white">Clear</a>
            </form>
