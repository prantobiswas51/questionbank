<x-guest-layout>
    <div class="max-w-6xl mx-auto p-4">
        ...
        <div class="search_box py-2 mb-4 ">
            <form action="{{ route('part_c') }}" method="get" class="flex flex-wrap gap-2 items-center">
                ...
                <a href="{{ route('part_c') }}" class="border p-2 rounded-lg bg-red-500 text-white">Clear</a>
            </form>
